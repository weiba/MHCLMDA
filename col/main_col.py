...
def train(epochs):
    ...
    if epoch != epochs - 1:
        ...
        # label
        label = create_resultmatrix(MD, testset, prolist)
        ...
        loss = 0.7*loss_v + loss_r_h + 0.3*loss_c
...
MD = np.loadtxt("col/data/md_delete.txt")
MM = np.loadtxt("col/data/mm_delete.txt")
DD = np.loadtxt("col/data/dd_delete.txt")
DG = np.loadtxt("col/data/dg_delete.txt")
MG = np.loadtxt("col/data/mg_delete.txt")
...
for time in range(1, n + 1):
    ...
    for f in range(1, args.cv_num + 1):
        ...
        print('auc1', auc1, 'aupr1', aupr1, 'recall1', recall1, 'precision1', precision1, 'f11', f11)
        print('========================================')
        auc = auc + auc1
        aupr = aupr + aupr1
        rec = rec + recall1
